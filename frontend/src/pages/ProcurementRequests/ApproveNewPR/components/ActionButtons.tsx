...
export const ActionButtons: React.FC<ActionButtonsProps> = ({
    ...
    return (
        <div className="flex max-sm:flex-col gap-2 justify-end items-center">
            <Button data-cy="delete-pr-button" variant="outline" className='border-primary text-primary hover:text-red-400 mr-4' size="sm" onClick={handleOpenDeletePRDialog}>
