                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction data-cy="confirm-delete-button" onClick={() => onDelete(editItem)} className='bg-destructive hover:bg-destructive/90'>Confirm Delete</AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        </AlertDialog>
